...
st.write("ဗီဒီယိုဖိုင်နှင့် AI Voiceover (MP3) ကို တင်၍ Copyright လွတ်အောင် တည်းဖြတ်ခြင်းနှင့် Telegram Noti ပါ စနစ်။")
...
if uploaded_video is not None and uploaded_audio is not None:
    ...
    if st.button("🚀 ဗီဒီယိုနှင့် အသံကို စတင်တည်းဖြတ်မည်"):
        ...
        try:
            ...
            # MoviePy ဗားရှင်းအသစ်နှင့် ကိုက်ညီသော Copyright Effects (Mirror & Resize)
